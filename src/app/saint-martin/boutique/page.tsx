            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {catWines.map((wine) => (
                  <div
                    key={wine.name}
                    className="bg-white border border-[#e8d5a3] p-6 flex flex-col relative"
                  >
                    {wine.badge && (
                      <span
                        className="absolute top-4 right-4 bg-[#c8a96e] text-[#1a0f0a] text-xs px-2 py-1 tracking-wider"
                        style={{ fontFamily: "var(--font-sans)" }}
                      >
                        {wine.badge}
                      </span>
                    ...
                    />
                    <h3
                      className="text-xl text-[#1a0f0a] mb-2 flex-1"
                      style={{ fontFamily: "var(--font-serif)", fontWeight: 400 }}
                    >
                      {wine.name}
                    </h3>
